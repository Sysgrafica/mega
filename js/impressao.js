class ImpressaoComponent {
    ...
    async render(container) {
        ...
        this.container.innerHTML = `
            <div class="dashboard-loader">
                ...
                <p>Carregando pedidos para impressão...</p>
            </div>
        `;

        try {
            await this.loadPrintingOrders();
            this.renderImpressaoPage();
        } catch (error) {
            console.error("Erro ao carregar página de impressão:", error);
            this.container.innerHTML = `
                <div class="error-page">
                    <i class="fas fa-exclamation-triangle"></i>
                    <h2>Erro ao carregar</h2>
                    <p>Ocorreu um erro ao carregar os pedidos para impressão.</p>
                    <button class="btn btn-primary" id="retry-impressao-button">Tentar Novamente</button>
                </div>
            `;
            document.getElementById('retry-impressao-button').addEventListener('click', () => {
    ...
    renderImpressaoPage() {
        let html = `
            <div class="page-header">
                <h1><i class="fas fa-print"></i> Impressão</h1>
            </div>
            ...
            <div class="impressao-container">
                <div id="impressao-orders-container">
    ...
    setupEventListeners() {
        ...
        // Ações dos pedidos
        const ordersContainer = document.getElementById('impressao-orders-container');
    ...
    applyFiltersAndRender() {
        ...
        const container = document.getElementById('impressao-orders-container');
    ...
    renderOrdersList(ordersToRender) {
        ...
        let ordersHtml = '<div class="impressao-orders-grid">';
            ...
            ordersHtml += `
                <div class="search-order-card ${situacao.class}" data-id="${order.id}">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="impressao-order-actions">
...
window.ImpressaoComponent = ImpressaoComponent; 